...
public class RRCTask extends MeasurementTask {
  ...
  public static class RRCDesc extends MeasurementDesc {
    ...
    // Perform RTT com.mobilyzer.measurements every GRANULARITY ms
    public int GRANULARITY = 500;
    // MIN / MAX is the echo packet size
    int MIN = 0;
    int MAX = 1024;
    // Default total number of com.mobilyzer.measurements
    int size = 31;
     ...
     * GRANULARITY is 500, then a default time of 6 means com.mobilyzer.measurements are taken 500 ms apart.
     */
...
//      ClassLoader loader = Thread.currentThread().getContextClassLoader();
  ...
  public static class RrcSizeTestData {
    ...
    long testId; // A unique id associated with a set of com.mobilyzer.measurements
  ...
  public static long[] inferDemotionHelper(InetAddress serverAddr, int wait, RRCTestData data,
    ...
    for (int j = 0; j < desc.GIVEUP_THRESHHOLD; j++) {
      ...
      // Send a bunch of large packets, all at once, and take com.mobilyzer.measurements on the result
//      signalStrengthLarge = utils.getCurrentRssi();
      ...
      // Send a bunch of small packets, all at once, and take com.mobilyzer.measurements on the result
