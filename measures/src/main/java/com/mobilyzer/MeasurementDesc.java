...
public abstract class MeasurementDesc implements Parcelable {
   ...
   *        measurement task.
   * @param startTime Earliest time that com.mobilyzer.measurements can be taken using this Task descriptor. The
   ...
   * @param endTime Latest time that com.mobilyzer.measurements can be taken using this Task descriptor. Tasks
   ...
   * @param intervalSec Minimum number of seconds to elapse between consecutive com.mobilyzer.measurements taken
